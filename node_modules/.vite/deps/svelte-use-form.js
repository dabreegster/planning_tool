...
var get_default_slot_changes = (dirty) => ({ value: dirty & 16 });
var get_default_slot_context = (ctx) => ({ value: ctx[4] });
function create_if_block(ctx) {
  let if_block_anchor;
  let current;
  let if_block = (ctx[7] || ctx[3]) && ctx[4] && create_if_block_1(ctx);
  const block = {
    c: function create() {
      if (if_block)
        if_block.c();
...
function create_if_block_1(ctx) {
  ...
  const block = {
    c: function create() {
      ...
      attr_dev(div, "class", div_class_value = "svelte-use-form-hint " + ctx[0]);
    ...
    p: function update(ctx2, dirty) {
      if (default_slot) {
        if (default_slot.p && (!current || dirty & 32784)) {
          update_slot_base(
            default_slot,
      ...
      if (!current || dirty & 1 && div_class_value !== (div_class_value = "svelte-use-form-hint " + ctx2[0])) {
...
function create_fragment(ctx) {
  let if_block_anchor;
  let current;
  let if_block = !(ctx[2] && ctx[5]) && !ctx[6] && create_if_block(ctx);
  const block = {
    c: function create() {
      if (if_block)
        if_block.c();
...
var get_default_slot_changes2 = (dirty) => ({ form: dirty & 1 });
var get_default_slot_context2 = (ctx) => ({ form: ctx[0] });
...
function isIgnoredElement(node) {
  return node.hasAttribute("data-suf-ignore") && node.getAttribute("data-suf-ignore") === "true" || node.getAttribute("data-suf-ignore") === true;
}
...
function validators(element2, validators2) {
  ...
  async function setupValidation() {
    ...
    const formControl = formReference.form[element2.name];
